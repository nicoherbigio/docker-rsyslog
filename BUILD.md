# Building instructions for the RSyslog Docker image
...
```
# Build the Docker image
docker build --no-cache --pull --tag nicoherbigde/rsyslog:debian-11 debian/11/default/
```
...
docker push nicoherbigde/rsyslog:debian-11
```
